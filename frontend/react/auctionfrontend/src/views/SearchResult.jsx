...
const SearchResult = (props) => {
  ...
  React.useEffect(() => {
    fetch(`/api/v1/auctions/?skip=0&limit=80&like=${searchKey}`, {
      mode: "cors",
    })
        ...
        <div className="row g-4">
          {auctions.map((auction) => {
            if (auction.state === "ongoing") {
              return (
                <div
                  className="col-12 col-md-4 col-lg-3 custom-card"
                  key={auction.id}
                >
                  <div className="card">
                    <img
                    ...
                    <div className="card-body border-top">
                      ...
                      <p className="card-text">
                        ...
                        }).format(auction.current_bid_amount)}
                      </p>
                      <p className="card-text">
                        <span>Ending Date: </span>
                        {new Intl.DateTimeFormat("en-GB").format(
                          new Date(auction.ending_date)
                        )}
                      </p>
